...
struct AboutView: View {
    ...
    var body: some View {
        List {
            ...
            // ── 法律 ──
            Section {
                aboutLink(String(localized: "隐私政策"), icon: "doc.text", url: "https://oss.omail.us.kg/privacy")
                aboutLink(String(localized: "使用条款"), icon: "doc.plaintext", url: "https://oss.omail.us.kg/terms")
            } header: {
                Text("法律")
            } footer: {
